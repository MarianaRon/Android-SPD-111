...
import step.learning.myapplication.orm.ChatMessage;
import step.learning.myapplication.orm.ChatResponse;
...
///////////
      ...
      /*
        ...
        try {  //1. Готуємо підключення та налаштовуємо його
            URL url = new URL(CHAT_URL);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setChunkedStreamingMode(0); //не ділити на чанг
...
///////////////////////////
        ...
        LinearLayout.LayoutParams  msgNotMyParams = new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
        );
        msgNotMyParams.setMargins(10,10,0,10);
        msgNotMyParams.gravity = Gravity.START;
...
//            }
            ...
            for (ChatMessage message : this.chatMessages){
                ...
                if(etNik.getText().toString().equals(message.getAuthor()) ){
                    ...
                    messageLayout.setBackground(notmyBackground);
                    messageLayout.setLayoutParams( msgNotMyParams);
                }
